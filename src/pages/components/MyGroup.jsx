      ...
      <Card className="mt-6 w-[345px] h-[450px] border border-gray-300">
        <CardBody>
          <div className="flex justify-between items-center ">
            ...
            {creategroupmodal ? (
              <button
                ...
                className=" bg-[#03014C] px-2 py-1 rounded-md text-white text-sm "
              >
                Cancle
              </button>
            ) : (
          ...
          <div className="h-[350px] overflow-y-scroll mt-[20px]">
            {creategroupmodal ? (
              <div>
                <h1 className=" text-[18px] text-blue-gray-900 font-semibold mb-1 ">
                  Create a group
                </h1>
                <input
                  onChange={(e) => setGroupname(e.target.value)}
                  className=" w-full border-2 border-gray-400 py-3 px-3 rounded-md "
                ...
                {groupname ? (
                  <button
                    ...
                    className="bg-[#03014C] px-2 py-1 rounded-md text-white text-sm mt-2"
                  >
                    Submit
                  </button>
                ) : (
                  <button
                    ...
                    className="bg-gray-400 px-2 py-1 rounded-md text-white text-sm mt-2"
                  >
                    Submit
                  </button>
                )}
