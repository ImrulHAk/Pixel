        ...
        <Grid item xs={6}>
          <div className=" h-[100vh] flex items-center justify-end ">
            <div className=" mr-[70px] ">
              <h1 className=" text-[35px] font-bold text-[#03014C] mb-[30px] ">
                Login to your account!
              </h1>
              <button
                onClick={handleGoogle}
                className=" flex items-center justify-center gap-[10px] w-[220px] h-[62px] border-solid border-[2px] border-[#03014C]/50 rounded-[10px] text-[16px] font-semibold text-[#03014C] "
              >
                <img src={LoginIcon} alt="login" /> Login with Google
              </button>
              ...
              <div className=" flex justify-between items-center mt-3 ">
                ...
                <Link
                  to="/forgetpassword"
                  className=" font-semibold text-[16px] text-[#03014C] "
                  href="#"
                >
                  Forgot password?
                </Link>
              ...
              {email && password ? (
                <Button
                  className="text-white text-[20px] font-normal w-[375px] mt-[40px] rounded-[10px] bg-[#4E1CFF] normal-case py-[16px]"
                  onClick={handleLogin}
                >
                  Login to Continue
                </Button>
